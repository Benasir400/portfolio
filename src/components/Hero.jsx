      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center z-10">
        ...
        <div>
          ...
          <p className="text-gray-400 text-lg mt-6 leading-8 max-w-xl">
            ...
            React, Java, Spring Boot, and MySQL. Focused on creating
            clean, scalable, and user-friendly digital experiences.
          </p>
        ...
        <div className="flex justify-center">
          ...
          <div className="relative">
            ...
            <img
              src="/profile.jpg"
              alt="Benasir"
              className="relative w-72 h-72 md:w-96 md:h-96 rounded-full object-cover border-4 border-violet-400 shadow-2xl"
            />
